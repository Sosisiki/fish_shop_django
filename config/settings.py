...
WHITENOISE_MANIFEST_STRICT = False  # Чтобы не падало при отсутствии .map файлов
...
# ============================================
# CLOUDINARY (медиафайлы в облаке)
# ============================================
import cloudinary
...
DEFAULT_FILE_STORAGE = 'cloudinary_storage.files.MediaCloudinaryStorage'
